...
public class AnvilSmithingRecipeSerializer extends net.minecraftforge.registries.ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<AnvilSmithingRecipe>
{
	@Nonnull
    @Override
	public AnvilSmithingRecipe read(@Nonnull ResourceLocation id, JsonObject json)
	{
	...
	@Override
	public AnvilSmithingRecipe read(@Nonnull ResourceLocation id, @Nonnull PacketBuffer buffer)
	{
	...
	@Override
	public void write(@Nonnull PacketBuffer buffer, AnvilSmithingRecipe recipe)
	{	
